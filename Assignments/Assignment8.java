...
// SPECIFICATION: This program provides the user with a list of options of different functions to choose from. Each option in the menu uses a different method in the Geek2.java file. These methods include a find, digitSum, pow, smallestDigit, and reverse methods.
