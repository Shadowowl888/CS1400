...
// SPECIFICATION: This program simulates a Bank simulation with a Bank Account superclass and Checking and Savings Account subclasses. The Bank Account class contains basic methods of withdraw, deposit, accessing the balance, and transferring the account. The Checking Account class has overridden withdraw and deposit methods, deduct maintenance fee, and close method. The Savings Account class has methods to add the interest earned and close the account.
