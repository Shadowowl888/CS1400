...
// SPECIFICATION: This program prompts the user for an integer for the size of the array and gives a list of menu options. It uses methods from the Collection class to perform different array operations. Some of the operations include adding a number, removing a number, doubling the array size, computing the average, and finding the largest number.
