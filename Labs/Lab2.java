...
// AUTHOR: Devin Khun
// FILENAME: Lab2.java
// SPECIFICATION: This program prompts the user to enter a first and last name and concatenates the two strings to create a full name. It prints the uppercase version of the full name and length of the name. It compares two strings using both the relational operator, ==, and the equals method
// FOR: CS 1400 - Lab #2
// TIME SPENT: 15 min
//-----------------------------------------------------------*/
